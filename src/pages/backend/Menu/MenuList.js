            ...
            <div className="card-header">
                <div className="row">
                    ...
                    <div className="col-6 text-end">
                        <Link to="/admin/menu/create" className="btn btn-sm btn-success"><FiPlus />Thêm</Link>
                    </div>
                </div>
            </div>
                        ...
                        {menus.map(function (menu, index) {
                            return (
                                <tr key={index}>
                                    ...
                                    <td className="text-center">
                                        <Link className="btn btn-sm btn-info me-1" to={"/admin/menu/show/" + menu.id}><FiEye /></Link>
                                        <Link className="btn btn-sm btn-primary me-1" to={"/admin/menu/update/" + menu.id}><FiEdit /></Link>
                                        <button onClick={()=>menuDelete(menu.id)} className="btn btn-sm btn-danger"><FiTrash2 /></button>
                                    </td>
