        ...
        <div className="card-header">
            <div className="row">
                ...
                <div className="col-6 text-end">
                    <Link className="btn btn-sm btn-primary me-1" to={"/admin/product/update/"+product.id}><FiEdit/>Sửa</Link>
                    <button onClick={()=>productDelete(product.id)} className="btn btn-sm btn-danger me-1"><FiTrash2/>Xóa</button>
