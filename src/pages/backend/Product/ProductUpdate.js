                ...
                <div className="card-body">
                    <div className="row">
                        <div className="col-md-9">
                            ...
                            <div className="md-3">
                                <label htmlFor="name">hình</label>
                                <input onChange={(e) => setImg(e.target.value)} type="number" name="price" value={price} className="form-control" />
                            </div>
                            <div className="md-3">
                                <label htmlFor="name">Số</label>
                                <input onChange={(e) => setNumber(e.target.value)} type="number" name="price" value={price} className="form-control" />
                            </div>
