            ...
            <?php foreach ($list as $row) : ?>
              ...
              <tr>
                ...
                <td class="text-center">
                  ...
                  <a class="btn btn-sm btn-info" href="index.php?option=slider&cat=restore&id=<?= $row['id'] ?>">
                  <i class="fas fa-undo-alt"></i>
                  </a>

                  <a class="btn btn-sm btn-danger" href="index.php?option=slider&cat=destroy&id=<?= $row['id'] ?>">
